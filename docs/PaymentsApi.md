# autoppia_backend_client.PaymentsApi
...
Admin-only endpoint for manual credit adjustments. Regular deposits should use TransactionView which auto-credits.
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_add_credit_create: %s\n" % e)
```
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_balance_create: %s\n" % e)
```
...
# **payments_balance_reduce_create**
> payments_balance_reduce_create()
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_balance_reduce_create: %s\n" % e)
```
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_get_wallet_create: %s\n" % e)
```
...
# **payments_save_transaction_create**
> payments_save_transaction_create()
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_save_transaction_create: %s\n" % e)
```
...
# **payments_transaction_history_create**
> payments_transaction_history_create()
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_transaction_history_create: %s\n" % e)
```
...
with autoppia_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PaymentsApi->payments_verify_wallet_create: %s\n" % e)
```
